package com.samyotech.smmatrimony.multipleimagepicker;
...
import com.samyotech.smmatrimony.multipleimagepicker.adapters.FolderAdapter;
import com.samyotech.smmatrimony.multipleimagepicker.adapters.ImageGridAdapter;
import com.samyotech.smmatrimony.multipleimagepicker.listeners.FolderOnItemClickListener;
import com.samyotech.smmatrimony.multipleimagepicker.listeners.ImageOnItemClickListener;
import com.samyotech.smmatrimony.multipleimagepicker.models.Folder;
import com.samyotech.smmatrimony.multipleimagepicker.models.Image;
import com.samyotech.smmatrimony.multipleimagepicker.utils.FileUtils;
import com.samyotech.smmatrimony.multipleimagepicker.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        // imgPathUri = FileProvider.getUriForFile(getActivity().getApplicationContext(), "com.samyotech.smmatrimony", mTmpFile);
